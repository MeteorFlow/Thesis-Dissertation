...
\input{Chapters/2.2-meteorology}
\section{Common Data format in meteorology}
\input{Chapters/2.3-data_format.tex}
\section{Related technologies}
\input{Chapters/2.4-technology.tex}
\section{Study Cases}
\input{Chapters/2.5-cases.tex}

\newpage
\chapter{System Analysis and Design}
\section{Exploratory Data Analysis}
\input{Chapters/3.1-data_study.tex}
\section{Requirements}
\input{Chapters/3.2-requirements.tex}
\section{Data management}
\input{Chapters/3.3-data_management.tex}
\section{System Architecture}
\input{Chapters/3.4-system.tex}

\newpage
\chapter{Implementation}
\section{Data Processing}
\input{Chapters/4.1-data_processing.tex}
\section{System}
\input{Chapters/4.2-software_development.tex}
\section{API Specification}
\input{Chapters/4.3-api_spec.tex}
\section{Datastore}
\input{Chapters/4.4-datastore.tex}
